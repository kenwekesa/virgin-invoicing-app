...
class Invoice(models.Model):
    ...
    number = models.CharField(
        null=False, default=increment_invoice_number, blank=False, max_length=100, unique=True)
    dueDate = models.DateField(null=True, blank=True)
    paymentTerms = models.CharField(
        choices=TERMS, default='15 days', max_length=100)
    ...
    discount = models.CharField(
        null=True, default=0, blank=True, max_length=10)
...
class Product(models.Model):
    ...
    description = models.CharField(
        null=False, blank=False, max_length=200, default="Anonimous")
    currency = models.CharField(
        blank=True, null=True, default='Kshs', max_length=100)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.uniqueId is None:
            ...
            self.slug = slugify('{} {}'.format(
                self.description, self.uniqueId))
